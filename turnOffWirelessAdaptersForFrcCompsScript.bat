...
powershell.exe -command "Disable-NetAdapter -Name "Wi-FI" -Confirm:$false"

powershell.exe -command "Disable-NetAdapter -Name 'Bluetooth Network Connection' -Confirm:$false"
